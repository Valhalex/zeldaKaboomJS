...
scene("game",({level, score}) =>{
    ...
    // if player walks onto X block take them to the next room
 ...
 //SLICER ACTIONS
    ...
    // creates collision so slicer doesn't phase through wall, and bounces off instead
...
scene("lose", ({score})=>{
    add([text(score,32), origin('center'), pos(width()/ 2)])
})
